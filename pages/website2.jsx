  ...
  return (
    <div className="w-full">
      <div className="w-screen h-[25vh] lg:h-[30vh] relative">
        ...
        <Image
          src="/publicc/assets/projects/website2.jpg"
          alt="Second Website"
      ...
      <div className="mx-auto max-w-6xl p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <p>
            This app was built using HTML - CSS - BOOTSTRAP. It was my second
            project that i made while attending the web design online course
          </p>
          <button className="px-8 py-2 mt-4 mr-8">
            <a href="https://ran-sy.github.io/website2/">Demo</a>
          </button>
